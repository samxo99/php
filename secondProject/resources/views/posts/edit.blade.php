...
<body class="antialiased" style="margin: 10px 25px">
...
<div>
    <form action="{{route('posts.update', $post->id)}}" method='POST'>
        ...
        <div class="form-group">
            ...
            <textarea type="Text" name="text" class="form-control" id="postText">{{old('text', $post->text)}}
             </textarea>
        ...
        <div class="form-group">
            ...
            <input type="Text" name="author" class="form-control" id="postAuthor" value="{{old('author', $post->author)}}">
